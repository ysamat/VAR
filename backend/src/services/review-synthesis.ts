...
/**
 * Take the user's answers to both questions and synthesize them into
 * a comprehensive, well-written review that other travelers can understand.
 *
 * Also infers numerical ratings (1-10) from the sentiment of the answers
 * to fill gaps in the aggregated numerical data.
 */
...
A2: "${verificationAnswer}"`,
  ...
  // Validate inferred ratings — clamp to 1-10 and only keep valid categories
